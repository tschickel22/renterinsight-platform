...
const QuoteAcceptModal = ({ quote, onClose, onAccept }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold">Accept Quote</h2>
            <button 
              onClick={onClose}
            ...
            <div className="bg-blue-50 p-4 rounded-lg flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-600 mt-1">
                  By accepting this quote, you agree to the terms and conditions of the purchase. 
                  This will create a binding agreement between you and our dealership.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-medium">{quote.validUntil}</span>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  ...
                  <p className="text-gray-500">
                    By checking this box, I confirm that I have read and agree to the terms and conditions of this quote.
                  </p>
                  {errors.agreed && (
...
export default QuoteAcceptModal;